...
class PhotoCompressionWorker(
    ...
    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO){
            ...
            val scaleThresholdWidth = params.inputData.getInt(
                KEY_COMPRESSION_WIDTH,
                0
            )
            val scaleThresholdHeight = params.inputData.getInt(
                KEY_COMPRESSION_HEIGHT,
                0
            )
            ///YAHAN  PX SCALE HOGA COMPRESSION KA, USING PARAMS.INPUTDATA.GETINT
            ...
            bitmap = bitmap.scale(scaleThresholdWidth,scaleThresholdHeight)
   ...
   companion object{
       ...
       const val KEY_COMPRESSION_WIDTH = "KEY_COMPRESSION_WIDTH"
       const val KEY_COMPRESSION_HEIGHT = "KEY_COMPRESSION_HEIGHT"
   }
}